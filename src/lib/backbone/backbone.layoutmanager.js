...
// A LayoutManager is simplyy a Backbone.View with some sugar.
    var LayoutManager = Backbone.View.extend({
            ...
            setView    : function (name, view, append) {
                ...
                if (!view.__manager__) {
                    console.log("unmanaged view ",name, view, this.views, append, root);
            ...
            _removeView : function (view, force) {
                ...
                if (!keep && (manager.append === true || force) && manager.hasRendered) {
                    ...
                    if (_.isArray(manager.parent.views[manager.selector])) {
                        ...
                        return manager.parent.getView(function (subview, i) {
                            // If the selectors match, splice off this View.
                            if (subview.__manager__.selector === manager.selector
                                && manager.parent.views[manager.selector][i] === view) {
